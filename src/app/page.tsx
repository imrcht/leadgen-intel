  ...
  return (
    <AppShell>
      ...
      {stats.length > 0 ? (
        ...
        <div className="glass rounded-2xl p-8 mb-8 text-center animate-fade-in border-dashed border-2 border-surface-700/50">
          <Activity className="w-8 h-8 text-surface-600 mx-auto mb-3" />
          <h3 className="text-lg font-semibold text-surface-200 mb-1">No Activity Yet</h3>
          <p className="text-sm text-surface-400 mb-4">Start your first lead search to see your stats here.</p>
          <Link
            href="/search"
            className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-primary-500/10 text-primary-400 hover:bg-primary-500/20 transition-all text-sm font-medium"
          >
        ...
        <div className="lg:col-span-2 glass rounded-2xl p-6 animate-slide-up">
          ...
          {recentSearches.length > 0 ? (
            ...
            <div className="text-center py-8">
              <p className="text-sm text-surface-500">No recent searches found.</p>
            </div>
          )}
        </div>
          ...
          >
            ...
            {stats.length > 0 ? (
              ...
              <div className="text-center py-4">
                <p className="text-xs text-surface-500">No leads to distribute yet.</p>
              </div>
            )}
          </div>
        </div>
